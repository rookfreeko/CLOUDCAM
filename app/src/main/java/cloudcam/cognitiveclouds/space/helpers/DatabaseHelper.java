...
public class DatabaseHelper {
    ...
    // table configuration
    private static final String TABLE_NAME = "pic_table";         // Table name
    ...
    private static final String TABLE_COLUMN_PIN = "_pin";
    ...
    public void insertData (String aName, String aPin) {

        // we are using ContentValues to avoid sql format errors

        ContentValues contentValues = new ContentValues();

        contentValues.put(TABLE_COLUMN_NAME, aName);
        contentValues.put(TABLE_COLUMN_PIN, aPin);
    ...
    public void remove(long id){
        ...
        database.execSQL("DELETE FROM pic_table WHERE _id = '" + string + "'");
    }

    public Cursor getid(long id){
        String string =String.valueOf(id);
        return database.rawQuery("SELECT * FROM pic_table WHERE _id = '" + string + "'",null);
    }
    ...
    private class DatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            ...
            String buildSQL = "CREATE TABLE " + TABLE_NAME + "( " + TABLE_COLUMN_ID + " INTEGER PRIMARY KEY, " +
                    TABLE_COLUMN_NAME + " TEXT, " + TABLE_COLUMN_PIN + " TEXT )";
